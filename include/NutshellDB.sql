...
insert  into `tb_usuarios`(`idUsuario`,`Logname`,`Passwd`,`Descripcion`,`Mail`,`Movil`,`active`,`activationDate`,`activationHash`,`InfoLastLoggin`,`LastAccess`,`AccessLevel`) values (1,'nutshell','625cf4d492fe38e88f33c7ee0b4938b0','Usuario de instalacion','',NULL,1,NULL,'','Acceso OK via Local Login','2013-07-25 11:04:09',0);
