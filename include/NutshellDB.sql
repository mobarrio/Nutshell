...
insert  into `tb_usuarios`(`idUsuario`,`Passwd`,`Descripcion`,`Mail`,`Movil`,`active`,`activationDate`,`activationHash`,`InfoLastLoggin`,`LastAccess`,`AccessLevel`) values ('nutshell','625cf4d492fe38e88f33c7ee0b4938b0','Usuario de instalacion','',NULL,1,NULL,'','Acceso OK via Local Login','2013-07-20 12:38:34',0);
