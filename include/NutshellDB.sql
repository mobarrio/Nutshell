...
insert  into `tb_configuracion`(`clave`,`valor`,`mascara`,`seccion`,`orden`,`desc`,`visible`) values ('LOGO_MINI','img/LogoTIADM.MIN.png','$_SESSION[\'_KEY_\'] = \'_VAL_\';','SESSION',300,'Path Logo (Min)',1),('LOGO_MEDIANO','img/LogoTIADM.MED.png','$_SESSION[\'_KEY_\'] = \'_VAL_\';','SESSION',301,'Path Logo (Med)',1),('LOGO_GRANDE','img/LogoTIADM.BIG.png','$_SESSION[\'_KEY_\'] = \'_VAL_\';','SESSION',302,'Path Logo (Big)',1),('LDAP_ACCOUNT_SUFFIX','','','LDAP',100,'ACCOUNT SUFFIX',0),('LDAP_BASE_DN','','','LDAP',101,'BASE DN',0),('LDAP_DC1','','','LDAP',102,'DC1',0),('LDAP_DC2','','','LDAP',103,'DC2',0),('LDAP_USER','','','LDAP',104,'Username',0),('LDAP_PASS','','','LDAP',105,'Password',0),('LDAP_ON','OFF','','LDAP',106,'LDAP ON/OFF',0),('LOGIN_DISABLED','OFF','','TIADM',400,'Login ON/OFF',0),('MAINTENANCEPAGE','OFF','','TIADM',401,'Maintenance ON/OFF',0),('COPYRIGHT','Mariano J. Obarrio Miles','$_SESSION[\'_KEY_\'] = \'_VAL_\';','SESSION',304,'Pie de pagina',1),('TRIGGERS','ON','','MYSQL',200,'Habilita / DesHabilita los TRIGGERS',0),('DOMACCESS','\'localhost\',\'192.168.1.4\'','$_SESSION[\'_KEY_\'] = array(_VAL_);','TIADM',402,'Dominios Permitidos',1),('SESSION','ini_set(\'memory_limit\', \'-1\');','_VAL_','PHP',0,'Permite utilizar toda la memoria disponible',1),('PATH_URL','http://192.168.1.4/Nutshell','$_SESSION[\'_KEY_\'] = \'_VAL_\';','SESSION',305,'HomeDir',1),('TIADM_REV','v1.0-P','$_SESSION[\'_KEY_\'] = \'_VAL_\';','SESSION',306,'Revision del TIADM',1),('LOGOUTPAGE','/logout.php','$_SESSION[\'_KEY_\'] = \'_VAL_\';','SESSION',306,'Pagina de Logout',1),('APP_DOCUMENT_ROOT','/Nutshell','$_SESSION[\'_KEY_\'] = \'_VAL_\';','SESSION',308,'DocumentRoot',1),('APPNAME','Nutshell','$_SESSION[\'_KEY_\'] = \'_VAL_\';','SESSION',307,'Nombre de la aplicacion',1),('APPSESTIMEOUT','600','$_SESSION[\"_KEY_\"] = _VAL_;','SESSION',309,'Tiempo de expliracion en segundos 600 = 10min',1),('SESSIONACTIVE','1','$_SESSION[\"_KEY_\"] = _VAL_;','SESSION',310,'Sesion activa no vuelve a recargar los datos',1),('CONFIG_WEBSITE_DOCUMENT_ROOT','/usr/home/exitweb/.ftp-users','$_SESSION[\'_KEY_\'] = \'_VAL_\';','SESSION',311,'Path a eliminar durante un Upload de TinyMCE',1),('APPWELCOMEMSG','Bienvenido al Sistema','$_SESSION[\'_KEY_\'] = \'_VAL_\';','SESSION',312,'Mensaje de la pagina principal',1);
...
insert  into `tb_usuarios`(`idUsuario`,`Passwd`,`Descripcion`,`Mail`,`Movil`,`active`,`activationDate`,`activationHash`,`InfoLastLoggin`,`LastAccess`,`AccessLevel`) values ('nutshell','625cf4d492fe38e88f33c7ee0b4938b0','Usuario de instalacion','',NULL,1,NULL,'','Acceso OK via Local Login','2013-07-21 13:03:28',0);
