...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_FOLDER_SHOWN_ON_TOP', false); //show your folders on the top of list if true or order by name 
	...
	define('CONFIG_OVERWRITTEN', true); //overwirte when processing paste
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,txt,bmp'); // 
	...
	// define('CONFIG_WEBSITE_DOCUMENT_ROOT', '/usr/home/exitweb/.ftp-users');	
	define('CONFIG_WEBSITE_DOCUMENT_ROOT', $_SESSION['CONFIG_WEBSITE_DOCUMENT_ROOT']);	
