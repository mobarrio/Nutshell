...
qq.FileUploaderBasic = function(o){
    this._options = {
        ...
        // messages                
        messages: {
            typeError: "{file} extension invalida. Solo {extensions} estan permitidas.",
            sizeError: "{file} es muy grande, el tamaño maximo es {sizeLimit}.",
            minSizeError: "{file} es muy pequeño, el tamaño minimo es {minSizeLimit}.",
            emptyError: "{file} esta vacio, por favor seleccione nuevamente los archivos sin este ultimo.",
            onLeave: "Los arcvhivos se estan subiendo, si uds se va ahora la subida se cancelara."            
        },
...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' + 
                  ...
                  ' <div class="qq-upload-button">Anexar Documentos al Pedido</div>' +
...
qq.UploadButton.prototype = {
    ...
    _createInput: function(){                
        ...
        var self = this;
        qq.attach(input, 'change', function()   { self._options.onChange(input); });
